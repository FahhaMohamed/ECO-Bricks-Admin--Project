...
import '../Add list/Bricks/bricksAdd.dart';
import '../Add list/Floor Tiles/floorTiesAdd.dart';
import '../Add list/Pavers/paversAdd.dart';
import '../Add list/Wall Tiles/wallTilesAdd.dart';
...
class _addScreenState extends State<addScreen> {
  ...
  CollectionReference? fileRef = FirebaseFirestore.instance.collection('Add History');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: false,
        backgroundColor: Colors.grey.shade100,
        title: Text("Add your items here",style: GoogleFonts.aBeeZee(color: Colors.black),),
      ),
      body: SafeArea(
        child: Center(
          child: Column(
