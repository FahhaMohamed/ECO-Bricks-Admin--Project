                    ...
                    showDialog(
                        ...
                        builder: (context) {
                          return AlertDialog(
                            ...
                            title: const Text("Create new Floor Tile",
                              style: TextStyle(
                                  color: Colors.black,
                                  fontSize: 18,
                                        ...
                                        children: [
                                                  ...
                                                  builder: (context) {
                                                    return AlertDialog(
                                                      ...
                                                      content: SizedBox(
                                                        ...
                                                        width: w,
                                                        child: floorTilesMain(xmoulds: x['moulds'], xfeet: x['feet'], xweight: x['weight'], docum: '${snapshot.data!.docs[i]['order']}', xname: x['name'],),
                                                      ),
                                                    );
                                                  }
                                              );
                                          ...
                                          GestureDetector(
                                            ...
                                            child: Container(
                                              ...
                                              child:x['Url'] == "" ? ClipOval(child: Image.asset('assets/emptyImg.jpg')) : ClipOval(child:Container(color:Colors.white,child:  Image.network(x['Url']),)),
                                            ),
                                          )
                                        ],
                                      )
