...
class AddRawMaterials extends StatefulWidget {
  const AddRawMaterials({super.key});

  @override
  State<AddRawMaterials> createState() => _AddRawMaterialsState();
}

class _AddRawMaterialsState extends State<AddRawMaterials> {

  CollectionReference? fileRef = FirebaseFirestore.instance.collection('Raw add History');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: false,
        backgroundColor: Colors.transparent,
        title: Text("Added History",style: TextStyle(color: Colors.black),),
      ),
      body: Column(
        children: [
          Container(
