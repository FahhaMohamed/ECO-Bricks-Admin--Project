...
class bricksSold extends StatefulWidget {


  const bricksSold({super.key});

  @override
  State<bricksSold> createState() => _bricksSoldState();
}

class _bricksSoldState extends State<bricksSold> {
