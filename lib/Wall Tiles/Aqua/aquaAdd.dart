...
class aquaAdd extends StatefulWidget {
  const aquaAdd({super.key});

  @override
  State<aquaAdd> createState() => _aquaAddState();
}

class _aquaAddState extends State<aquaAdd> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
                                          ...
                                          children: [
                                            ...
                                            TextButton(
                                                onPressed: () async {
                                                  ...
                                                  await FirebaseFirestore.instance.collection('Aqua Wall Tiles').doc(color).set({
                                                    'color' : color,
                                                    'amount' : int.tryParse(amount),
                                                  });
                                                },
      ...
      child: Container(
        ...
        child: const Center(child: Text("Aqua",style: TextStyle(fontSize: 19,color: Colors.black),)),
      ),
    );
  }
}
