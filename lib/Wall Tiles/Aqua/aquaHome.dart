...
class AquaHome extends StatefulWidget {

  final String url;

  const AquaHome({required this.url,super.key});

  @override
  State<AquaHome> createState() => _AquaHomeState();
}

class _AquaHomeState extends State<AquaHome> {

  bool isTapped = true;
  bool isExpanded = false;

  CollectionReference? fileRef = FirebaseFirestore.instance.collection('Aqua Wall Tiles');
