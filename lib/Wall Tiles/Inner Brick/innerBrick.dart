...
class innerBrickAdd extends StatefulWidget {
  const innerBrickAdd({super.key});

  @override
  State<innerBrickAdd> createState() => _innerBrickAddState();
}

class _innerBrickAddState extends State<innerBrickAdd> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
                                          ...
                                          children: [
                                            ...
                                            TextButton(
                                                onPressed: () async {
                                                  ...
                                                  await FirebaseFirestore.instance.collection('Inner Brick Wall Tiles').doc(color).set({
                                                    'color' : color,
                                                    'amount' : int.tryParse(amount),
                                                  });
                                                },
      ...
      child: Container(
        ...
        child: const Center(child: Text("Inner Brick",style: TextStyle(fontSize: 19,color: Colors.black),)),
      ),
    );
  }
}
