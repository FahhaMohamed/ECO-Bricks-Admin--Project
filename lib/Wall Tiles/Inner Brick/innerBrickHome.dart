...
class InnerBrickHome extends StatefulWidget {

  final String url;

  const InnerBrickHome({required this.url,super.key});

  @override
  State<InnerBrickHome> createState() => _InnerBrickHomeState();
}

class _InnerBrickHomeState extends State<InnerBrickHome> {

  bool isTapped = true;
  bool isExpanded = false;

  CollectionReference? fileRef = FirebaseFirestore.instance.collection('Inner Brick Wall Tiles');
  ...
  int value = 0;
  String name = 'Inner Brick Wall Tiles';
