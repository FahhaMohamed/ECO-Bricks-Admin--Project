...
class innerBrickSold extends StatefulWidget {
  const innerBrickSold({super.key});

  @override
  State<innerBrickSold> createState() => _innerBrickSoldState();
}

class _innerBrickSoldState extends State<innerBrickSold> {
