...
class MatteHome extends StatefulWidget {

  final String url;

  const MatteHome({required this.url,super.key});

  @override
  State<MatteHome> createState() => _MatteHomeState();
}

class _MatteHomeState extends State<MatteHome> {

  bool isTapped = true;
  bool isExpanded = false;

  CollectionReference? fileRef = FirebaseFirestore.instance.collection('Matte Wall Tiles');
