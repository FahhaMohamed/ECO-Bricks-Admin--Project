...
class matteAdd extends StatefulWidget {
  const matteAdd({super.key});

  @override
  State<matteAdd> createState() => _matteAddState();
}

class _matteAddState extends State<matteAdd> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
                                          ...
                                          children: [
                                            ...
                                            TextButton(
                                                onPressed: () async {
                                                  ...
                                                  await FirebaseFirestore.instance.collection('Matte Wall Tiles').doc(color).set({
                                                    'color' : color,
                                                    'amount' : int.tryParse(amount),
                                                  });
                                                },
      ...
      child: Container(
        ...
        child: const Center(child: Text("Matte",style: TextStyle(fontSize: 19,color: Colors.black),)),
      ),
    );
  }
}
