...
class woodAdd extends StatefulWidget {
  const woodAdd({super.key});

  @override
  State<woodAdd> createState() => _woodAddState();
}

class _woodAddState extends State<woodAdd> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
                                          ...
                                          children: [
                                            ...
                                            TextButton(
                                                onPressed: () async {
                                                  ...
                                                  await FirebaseFirestore.instance.collection('Wood Wall Tiles').doc(color).set({
                                                    'color' : color,
                                                    'amount' : int.tryParse(amount),
                                                  });
                                                },
      ...
      child: Container(
        ...
        child: const Center(child: Text("Wood",style: TextStyle(fontSize: 19,color: Colors.black),)),
      ),
    );
  }
}
