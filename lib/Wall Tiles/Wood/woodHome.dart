...
class WoodHome extends StatefulWidget {

  final String url;

  const WoodHome({required this.url,super.key});

  @override
  State<WoodHome> createState() => _WoodHomeState();
}

class _WoodHomeState extends State<WoodHome> {

  bool isTapped = true;
  bool isExpanded = false;

  CollectionReference? fileRef = FirebaseFirestore.instance.collection('Wood Wall Tiles');
