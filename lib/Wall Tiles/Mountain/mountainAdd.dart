...
class mountainAdd extends StatefulWidget {
  const mountainAdd({super.key});

  @override
  State<mountainAdd> createState() => _mountainAddState();
}

class _mountainAddState extends State<mountainAdd> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
                                          ...
                                          children: [
                                            ...
                                            TextButton(
                                                onPressed: () async {
                                                  ...
                                                  await FirebaseFirestore.instance.collection('Mountain Wall Tiles').doc(color).set({
                                                    'color' : color,
                                                    'amount' : int.tryParse(amount),
                                                  });
                                                },
      ...
      child: Container(
        ...
        child: const Center(child: Text("Mountain",style: TextStyle(fontSize: 19,color: Colors.black),)),
      ),
    );
  }
}
