...
class MountainHome extends StatefulWidget {

  final String url;

  const MountainHome({required this.url,super.key});

  @override
  State<MountainHome> createState() => _MountainHomeState();
}

class _MountainHomeState extends State<MountainHome> {

  bool isTapped = true;
  bool isExpanded = false;

  CollectionReference? fileRef = FirebaseFirestore.instance.collection('Mountain Wall Tiles');
  ...
  int value = 0;
  String name = 'Mountain Wall Tiles';
