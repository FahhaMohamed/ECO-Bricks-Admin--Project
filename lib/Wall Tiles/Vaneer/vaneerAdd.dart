...
class vaneerAdd extends StatefulWidget {
  const vaneerAdd({super.key});

  @override
  State<vaneerAdd> createState() => _vaneerAddState();
}

class _vaneerAddState extends State<vaneerAdd> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
                                          ...
                                          children: [
                                            ...
                                            TextButton(
                                                onPressed: () async {
                                                  ...
                                                  await FirebaseFirestore.instance.collection('Vaneer Wall Tiles').doc(color).set({
                                                    'color' : color,
                                                    'amount' : int.tryParse(amount),
                                                  });
                                                },
      ...
      child: Container(
        ...
        child: const Center(child: Text("Vaneer",style: TextStyle(fontSize: 19,color: Colors.black),)),
      ),
    );
  }
}
