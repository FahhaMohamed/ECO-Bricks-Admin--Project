...
class VaneerHome extends StatefulWidget {

  final String url;

  const VaneerHome({required this.url,super.key});

  @override
  State<VaneerHome> createState() => _VaneerHomeState();
}

class _VaneerHomeState extends State<VaneerHome> {

  bool isTapped = true;
  bool isExpanded = false;

  CollectionReference? fileRef = FirebaseFirestore.instance.collection('Vaneer Wall Tiles');
