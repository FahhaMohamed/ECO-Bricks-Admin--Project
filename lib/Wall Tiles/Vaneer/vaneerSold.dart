...
class vaneerSold extends StatefulWidget {
  const vaneerSold({super.key});

  @override
  State<vaneerSold> createState() => _vaneerSoldState();
}

class _vaneerSoldState extends State<vaneerSold> {
