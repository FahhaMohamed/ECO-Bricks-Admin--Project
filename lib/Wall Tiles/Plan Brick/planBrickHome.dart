...
class PlanBrickHome extends StatefulWidget {

  final String url;

  const PlanBrickHome({required this.url,super.key});

  @override
  State<PlanBrickHome> createState() => _PlanBrickHomeState();
}

class _PlanBrickHomeState extends State<PlanBrickHome> {

  bool isTapped = true;
  bool isExpanded = false;

  CollectionReference? fileRef = FirebaseFirestore.instance.collection('Plan Brick Wall Tiles');
  ...
  int value = 0;
  String name = 'Plan Brick Wall Tiles';
