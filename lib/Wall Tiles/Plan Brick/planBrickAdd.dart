...
class planBrickAdd extends StatefulWidget {
  const planBrickAdd({super.key});

  @override
  State<planBrickAdd> createState() => _planBrickAddState();
}

class _planBrickAddState extends State<planBrickAdd> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
                                          ...
                                          children: [
                                            ...
                                            TextButton(
                                                onPressed: () async {
                                                  ...
                                                  await FirebaseFirestore.instance.collection('Plan Brick Wall Tiles').doc(color).set({
                                                    'color' : color,
                                                    'amount' : int.tryParse(amount),
                                                  });
                                                },
      ...
      child: Container(
        ...
        child: const Center(child: Text("Plan Brick",style: TextStyle(fontSize: 19,color: Colors.black),)),
      ),
    );
  }
}
