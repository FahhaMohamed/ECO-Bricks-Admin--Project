...
class planBrickSold extends StatefulWidget {
  const planBrickSold({super.key});

  @override
  State<planBrickSold> createState() => _planBrickSoldState();
}

class _planBrickSoldState extends State<planBrickSold> {
