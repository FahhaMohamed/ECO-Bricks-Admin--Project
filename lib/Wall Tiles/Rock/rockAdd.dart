...
class rockAdd extends StatefulWidget {
  const rockAdd({super.key});

  @override
  State<rockAdd> createState() => _rockAddState();
}

class _rockAddState extends State<rockAdd> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
                                          ...
                                          children: [
                                            ...
                                            TextButton(
                                                onPressed: () async {
                                                  ...
                                                  await FirebaseFirestore.instance.collection('Rock Wall Tiles').doc(color).set({
                                                    'color' : color,
                                                    'amount' : int.tryParse(amount),
                                                  });
                                                },
      ...
      child: Container(
        ...
        child: const Center(child: Text("Rock",style: TextStyle(fontSize: 19,color: Colors.black),)),
      ),
    );
  }
}
