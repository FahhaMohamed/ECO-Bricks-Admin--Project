...
class RockHome extends StatefulWidget {

  final String url;

  const RockHome({required this.url,super.key});

  @override
  State<RockHome> createState() => _RockHomeState();
}

class _RockHomeState extends State<RockHome> {

  bool isTapped = true;
  bool isExpanded = false;

  CollectionReference? fileRef = FirebaseFirestore.instance.collection('Rock Wall Tiles');
  @override
  void initState() {
    super.initState();
    fetchValue();
