...
class spiderRockSold extends StatefulWidget {
  const spiderRockSold({super.key});

  @override
  State<spiderRockSold> createState() => _spiderRockSoldState();
}

class _spiderRockSoldState extends State<spiderRockSold> {
