...
class SpiderRockHome extends StatefulWidget {

  final String url;

  const SpiderRockHome({required this.url,super.key});

  @override
  State<SpiderRockHome> createState() => _SpiderRockHomeState();
}

class _SpiderRockHomeState extends State<SpiderRockHome> {

  bool isTapped = true;
  bool isExpanded = false;

  CollectionReference? fileRef = FirebaseFirestore.instance.collection('Spider Rock Wall Tiles');
  ...
  int value = 0;
  String name = 'Spider Rock Wall Tiles';

  CollectionReference? dataRef = FirebaseFirestore.instance.collection('wall tiles');

  fetchValue() async {

    var _value = await FirebaseFirestore.instance.collection('wall tiles').doc(name);
