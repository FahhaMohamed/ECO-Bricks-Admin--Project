...
class spiderRockAdd extends StatefulWidget {
  const spiderRockAdd({super.key});

  @override
  State<spiderRockAdd> createState() => _spiderRockAddState();
}

class _spiderRockAddState extends State<spiderRockAdd> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
                                          ...
                                          children: [
                                            ...
                                            TextButton(
                                                onPressed: () async {
                                                  ...
                                                  await FirebaseFirestore.instance.collection('Spider Rock Wall Tiles').doc(color).set({
                                                    'color' : color,
                                                    'amount' : int.tryParse(amount),
                                                  });
                                                },
      ...
      child: Container(
        ...
        child: const Center(child: Text("Spider Rock",style: TextStyle(fontSize: 19,color: Colors.black),)),
      ),
    );
  }
}
