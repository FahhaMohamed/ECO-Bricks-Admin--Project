...
class BambooHome extends StatefulWidget {

  final String url;

  const BambooHome({required this.url,super.key});

  @override
  State<BambooHome> createState() => _BambooHomeState();
}

class _BambooHomeState extends State<BambooHome> {

  bool isTapped = true;
  bool isExpanded = false;

  CollectionReference? fileRef = FirebaseFirestore.instance.collection('Bamboo Wall Tiles');
