...
class bambooAdd extends StatefulWidget {
  const bambooAdd({super.key});

  @override
  State<bambooAdd> createState() => _bambooAddState();
}

class _bambooAddState extends State<bambooAdd> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
                                          ...
                                          children: [
                                            ...
                                            TextButton(
                                                onPressed: () async {
                                                  ...
                                                  await FirebaseFirestore.instance.collection('Bamboo Wall Tiles').doc(color).set({
                                                    'color' : color,
                                                    'amount' : int.tryParse(amount),
                                                  });
                                                },
      ...
      child: Container(
        ...
        child: const Center(child: Text("Bamboo",style: TextStyle(fontSize: 19,color: Colors.black),)),
      ),
    );
  }
}
