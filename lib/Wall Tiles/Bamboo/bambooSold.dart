...
class bambooSold extends StatefulWidget {
  const bambooSold({super.key});

  @override
  State<bambooSold> createState() => _bambooSoldState();
}

class _bambooSoldState extends State<bambooSold> {
