                  ...
                  child: Center(
                    child: Row(
                      ...
                      children: [
                        SizedBox(
                            width: w*0.24,
                            child: const Center(child: Text("Type",style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),))
                        ),
                        SizedBox(
                            width: w*0.24,
                            child: const Center(child: Text("Amount",style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),))
                        ),
                        SizedBox(
                            width: w*0.24,
                            child: const Center(child: Text("Colour",style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),))
                        ),
                        SizedBox(
                            width: w*0.24,
                            child: const Center(child: Text("Sold Date",style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500),))
                        ),
                      ],
                    ),
                  ),
