...
class linesStepSold extends StatefulWidget {
  const linesStepSold({super.key});

  @override
  State<linesStepSold> createState() => _linesStepSoldState();
}

class _linesStepSoldState extends State<linesStepSold> {
