...
class linesStepAdd extends StatefulWidget {
  const linesStepAdd({super.key});

  @override
  State<linesStepAdd> createState() => _linesStepAddState();
}

class _linesStepAddState extends State<linesStepAdd> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
                                          ...
                                          children: [
                                            ...
                                            TextButton(
                                                onPressed: () async {
                                                  ...
                                                  await FirebaseFirestore.instance.collection('Lines Step Floor Tiles').doc(color).set({
                                                    'color' : color,
                                                    'amount' : int.tryParse(amount),
                                                  });
                                                },
      ...
      child: Container(
        ...
        child: const Center(child: Text("Lines Step",style: TextStyle(fontSize: 19,color: Colors.black),)),
      ),
    );
  }
}
