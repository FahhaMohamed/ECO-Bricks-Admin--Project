...
class LinesStepHome extends StatefulWidget {

  final String url;

  const LinesStepHome({required this.url,super.key});

  @override
  State<LinesStepHome> createState() => _LinesStepHomeState();
}

class _LinesStepHomeState extends State<LinesStepHome> {

  bool isTapped = true;
  bool isExpanded = false;

  CollectionReference? fileRef = FirebaseFirestore.instance.collection('Lines Step Floor Tiles');
  ...
  int value = 0;
  String name = 'Lines Step Floor Tiles';
