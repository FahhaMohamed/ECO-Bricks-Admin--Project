...
class OvalStepHome extends StatefulWidget {

  final String url;

  const OvalStepHome({required this.url,super.key});

  @override
  State<OvalStepHome> createState() => _OvalStepHomeState();
}

class _OvalStepHomeState extends State<OvalStepHome> {

  bool isTapped = true;
  bool isExpanded = false;

  CollectionReference? fileRef = FirebaseFirestore.instance.collection('Oval Step Floor Tiles');
  ...
  int value = 0;
  String name = 'Oval Step Floor Tiles';
