...
class ovalStepSold extends StatefulWidget {
  const ovalStepSold({super.key});

  @override
  State<ovalStepSold> createState() => _ovalStepSoldState();
}

class _ovalStepSoldState extends State<ovalStepSold> {
