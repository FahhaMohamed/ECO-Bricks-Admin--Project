...
class ovalStepAdd extends StatefulWidget {
  const ovalStepAdd({super.key});

  @override
  State<ovalStepAdd> createState() => _ovalStepAddState();
}

class _ovalStepAddState extends State<ovalStepAdd> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
                                          ...
                                          children: [
                                            ...
                                            TextButton(
                                                onPressed: () async {
                                                  ...
                                                  await FirebaseFirestore.instance.collection('Oval Step Floor Tiles').doc(color).set({
                                                    'color' : color,
                                                    'amount' : int.tryParse(amount),
                                                  });
                                                },
      ...
      child: Container(
        ...
        child: const Center(child: Text("Oval Step",style: TextStyle(fontSize: 19,color: Colors.black),)),
      ),
    );
  }
}
