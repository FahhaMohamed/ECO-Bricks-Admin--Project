...
class squareStepSold extends StatefulWidget {
  const squareStepSold({super.key});

  @override
  State<squareStepSold> createState() => _squareStepSoldState();
}

class _squareStepSoldState extends State<squareStepSold> {
