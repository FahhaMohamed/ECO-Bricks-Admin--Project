...
class squareStepAdd extends StatefulWidget {
  const squareStepAdd({super.key});

  @override
  State<squareStepAdd> createState() => _squareStepAddState();
}

class _squareStepAddState extends State<squareStepAdd> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
                                          ...
                                          children: [
                                            ...
                                            TextButton(
                                                onPressed: () async {
                                                  ...
                                                  await FirebaseFirestore.instance.collection('Square Step Floor Tiles').doc(color).set({
                                                    'color' : color,
                                                    'amount' : int.tryParse(amount),
                                                  });
                                                },
      ...
      child: Container(
        ...
        child: const Center(child: Text("Square Step",style: TextStyle(fontSize: 19,color: Colors.black),)),
      ),
    );
  }
}
