...
class MoonFaceHome extends StatefulWidget {

  final String url;

  const MoonFaceHome({required this.url,super.key});

  @override
  State<MoonFaceHome> createState() => _MoonFaceHomeState();
}

class _MoonFaceHomeState extends State<MoonFaceHome> {

  bool isTapped = true;
  bool isExpanded = false;

  CollectionReference? fileRef = FirebaseFirestore.instance.collection('Moon Face Floor Tiles');
  ...
  int value = 0;
  String name = 'Moon Face Floor Tiles';
