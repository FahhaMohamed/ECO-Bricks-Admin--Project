...
class moonFaceAdd extends StatefulWidget {
  const moonFaceAdd({super.key});

  @override
  State<moonFaceAdd> createState() => _moonFaceAddState();
}

class _moonFaceAddState extends State<moonFaceAdd> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
                                          ...
                                          children: [
                                            ...
                                            TextButton(
                                                onPressed: () async {
                                                  ...
                                                  await FirebaseFirestore.instance.collection('Moon Face Floor Tiles').doc(color).set({
                                                    'color' : color,
                                                    'amount' : int.tryParse(amount),
                                                  });
                                                },
      ...
      child: Container(
        ...
        child: const Center(child: Text("Moon Face",style: TextStyle(fontSize: 19,color: Colors.black),)),
      ),
    );
  }
}
