...
class ft06Add extends StatefulWidget {
  const ft06Add({super.key});

  @override
  State<ft06Add> createState() => _ft06AddState();
}

class _ft06AddState extends State<ft06Add> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
                                          ...
                                          children: [
                                            ...
                                            TextButton(
                                                onPressed: () async {
                                                  ...
                                                  await FirebaseFirestore.instance.collection('FT 06 Floor Tiles').doc(color).set({
                                                    'color' : color,
                                                    'amount' : int.tryParse(amount),
                                                  });
                                                },
      ...
      child: Container(
        ...
        child: const Center(child: Text("FT 06",style: TextStyle(fontSize: 19,color: Colors.black),)),
      ),
    );
  }
}
