...
class FT06Home extends StatefulWidget {

  final String url;

  const FT06Home({required this.url,super.key});

  @override
  State<FT06Home> createState() => _FT06HomeState();
}

class _FT06HomeState extends State<FT06Home> {

  bool isTapped = true;
  bool isExpanded = false;

  CollectionReference? fileRef = FirebaseFirestore.instance.collection('FT 06 Floor Tiles');
