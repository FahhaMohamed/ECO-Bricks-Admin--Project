...
class ft03Add extends StatefulWidget {
  const ft03Add({super.key});

  @override
  State<ft03Add> createState() => _ft03AddState();
}

class _ft03AddState extends State<ft03Add> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
                                          ...
                                          children: [
                                            ...
                                            TextButton(
                                                onPressed: () async {
                                                  ...
                                                  await FirebaseFirestore.instance.collection('FT 03 Floor Tiles').doc(color).set({
                                                    'color' : color,
                                                    'amount' : int.tryParse(amount),
                                                  });
                                                },
      ...
      child: Container(
        ...
        child: const Center(child: Text("FT 03",style: TextStyle(fontSize: 19,color: Colors.black),)),
      ),
    );
  }
}
