...
class FT03Home extends StatefulWidget {

  final String url;

  const FT03Home({required this.url,super.key});

  @override
  State<FT03Home> createState() => _FT03HomeState();
}

class _FT03HomeState extends State<FT03Home> {

  bool isTapped = true;
  bool isExpanded = false;

  CollectionReference? fileRef = FirebaseFirestore.instance.collection('FT 03 Floor Tiles');
