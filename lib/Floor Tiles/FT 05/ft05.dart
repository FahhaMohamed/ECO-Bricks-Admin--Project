...
class ft05Add extends StatefulWidget {
  const ft05Add({super.key});

  @override
  State<ft05Add> createState() => _ft05AddState();
}

class _ft05AddState extends State<ft05Add> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
                                          ...
                                          children: [
                                            ...
                                            TextButton(
                                                onPressed: () async {
                                                  ...
                                                  await FirebaseFirestore.instance.collection('FT 05 Floor Tiles').doc(color).set({
                                                    'color' : color,
                                                    'amount' : int.tryParse(amount),
                                                  });
                                                },
      ...
      child: Container(
        ...
        child: const Center(child: Text("FT 05",style: TextStyle(fontSize: 19,color: Colors.black),)),
      ),
    );
  }
}
