...
class FT05Home extends StatefulWidget {

  final String url;

  const FT05Home({required this.url,super.key});

  @override
  State<FT05Home> createState() => _FT05HomeState();
}

class _FT05HomeState extends State<FT05Home> {

  bool isTapped = true;
  bool isExpanded = false;

  CollectionReference? fileRef = FirebaseFirestore.instance.collection('FT 05 Floor Tiles');
