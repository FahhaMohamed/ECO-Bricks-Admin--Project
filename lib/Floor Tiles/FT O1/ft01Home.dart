...
class FT01Home extends StatefulWidget {

  final String url;

  const FT01Home({required this.url,super.key});

  @override
  State<FT01Home> createState() => _FT01HomeState();
}

class _FT01HomeState extends State<FT01Home> {
