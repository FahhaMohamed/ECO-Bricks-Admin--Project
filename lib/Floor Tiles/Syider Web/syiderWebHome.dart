...
class SyiderWebHome extends StatefulWidget {

  final String url;

  const SyiderWebHome({required this.url,super.key});

  @override
  State<SyiderWebHome> createState() => _SyiderWebHomeState();
}

class _SyiderWebHomeState extends State<SyiderWebHome> {

  bool isTapped = true;
  bool isExpanded = false;

  CollectionReference? fileRef = FirebaseFirestore.instance.collection('Spider Web Floor Tiles');
  ...
  int value = 0;
  String name = 'Spider Web Floor Tiles';
