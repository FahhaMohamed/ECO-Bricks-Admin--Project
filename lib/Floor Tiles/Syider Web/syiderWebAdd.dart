...
class spyiderWebAdd extends StatefulWidget {
  const spyiderWebAdd({super.key});

  @override
  State<spyiderWebAdd> createState() => _spyiderWebAddState();
}

class _spyiderWebAddState extends State<spyiderWebAdd> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
                                          ...
                                          children: [
                                            ...
                                            TextButton(
                                                onPressed: () async {
                                                  ...
                                                  await FirebaseFirestore.instance.collection('Spider Web Floor Tiles').doc(color).set({
                                                    'color' : color,
                                                    'amount' : int.tryParse(amount),
                                                  });
                                                },
      ...
      child: Container(
        ...
        child: const Center(child: Text("Spider Web",style: TextStyle(fontSize: 19,color: Colors.black),)),
      ),
    );
  }
}
