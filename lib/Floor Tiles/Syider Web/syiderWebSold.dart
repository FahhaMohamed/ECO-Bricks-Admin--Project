...
class spyiderWebSold extends StatefulWidget {
  const spyiderWebSold({super.key});

  @override
  State<spyiderWebSold> createState() => _spyiderWebSoldState();
}

class _spyiderWebSoldState extends State<spyiderWebSold> {
