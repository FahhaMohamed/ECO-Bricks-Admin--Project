...
class FT02Home extends StatefulWidget {

  final String url;

  const FT02Home({required this.url,super.key});

  @override
  State<FT02Home> createState() => _FT02HomeState();
}

class _FT02HomeState extends State<FT02Home> {

  bool isTapped = true;
  bool isExpanded = false;

  CollectionReference? fileRef = FirebaseFirestore.instance.collection('FT 02 Floor Tiles');
