...
class ft02Add extends StatefulWidget {
  const ft02Add({super.key});

  @override
  State<ft02Add> createState() => _ft02AddState();
}

class _ft02AddState extends State<ft02Add> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
                                          ...
                                          children: [
                                            ...
                                            TextButton(
                                                onPressed: () async {
                                                  ...
                                                  await FirebaseFirestore.instance.collection('FT 02 Floor Tiles').doc(color).set({
                                                    'color' : color,
                                                    'amount' : int.tryParse(amount),
                                                  });
                                                },
      ...
      child: Container(
        ...
        child: const Center(child: Text("FT 02",style: TextStyle(fontSize: 19,color: Colors.black),)),
      ),
    );
  }
}
