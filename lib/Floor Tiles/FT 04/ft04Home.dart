...
class FT04Home extends StatefulWidget {

  final String url;

  const FT04Home({required this.url,super.key});

  @override
  State<FT04Home> createState() => _FT04HomeState();
}

class _FT04HomeState extends State<FT04Home> {

  bool isTapped = true;
  bool isExpanded = false;

  CollectionReference? fileRef = FirebaseFirestore.instance.collection('FT 04 Floor Tiles');
