...
class ft04Add extends StatefulWidget {
  const ft04Add({super.key});

  @override
  State<ft04Add> createState() => _ft04AddState();
}

class _ft04AddState extends State<ft04Add> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
                                          ...
                                          children: [
                                            ...
                                            TextButton(
                                                onPressed: () async {
                                                  ...
                                                  await FirebaseFirestore.instance.collection('FT 04 Floor Tiles').doc(color).set({
                                                    'color' : color,
                                                    'amount' : int.tryParse(amount),
                                                  });
                                                },
      ...
      child: Container(
        ...
        child: const Center(child: Text("FT 04",style: TextStyle(fontSize: 19,color: Colors.black),)),
      ),
    );
  }
}
