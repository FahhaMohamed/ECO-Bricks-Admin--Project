...
class floorTilesMain extends StatefulWidget {
  ...
  final String docum;
  const floorTilesMain({required this.xname,required this.xmoulds,required this.xfeet,required this.xweight,required this.docum,super.key});

  @override
  State<floorTilesMain> createState() => _floorTilesMainState();
}

class _floorTilesMainState extends State<floorTilesMain> {

  CollectionReference? fileRef = FirebaseFirestore.instance.collection("Floor tiles");
                ...
                builder: (context) {
                  return AlertDialog(
                    ...
                    content: SizedBox(
                      ...
                      width: w,
                      child: GalleryScreen(title: widget.xname, collection: 'Floor tiles', docum: widget.docum,),
                    ),
                  );
                }
            );
