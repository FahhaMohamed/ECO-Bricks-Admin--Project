...
class hydraulicPaversMain extends StatefulWidget {
  ...
  final String docum;
  const hydraulicPaversMain({required this.xname,required this.xfeet,required this.xweight,required this.docum,super.key});
                ...
                builder: (context) {
                  return AlertDialog(
                    ...
                    content: SizedBox(
                      ...
                      width: w,
                      child: GalleryScreen(title: widget.xname, collection: 'Hydraulic Pavers', docum: widget.docum,),
                    ),
                  );
                }
            );
