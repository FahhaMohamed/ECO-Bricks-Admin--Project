...
class paverMain extends StatefulWidget {
  ...
  final String docum;
  const paverMain({required this.xname,required this.xmoulds,required this.xfeet,required this.xweight,required this.docum,super.key});

  @override
  State<paverMain> createState() => _paverMainState();
}

class _paverMainState extends State<paverMain> {

  CollectionReference? fileRef = FirebaseFirestore.instance.collection("Pavers");
                ...
                builder: (context) {
                  return AlertDialog(
                    ...
                    content: SizedBox(
                      ...
                      width: w,
                      child: GalleryScreen(title: widget.xname, collection: 'Pavers', docum: widget.docum,),
                    ),
                  );
                }
            );
