...
class tryArcSold extends StatefulWidget {
  const tryArcSold({super.key});

  @override
  State<tryArcSold> createState() => _tryArcSoldState();
}

class _tryArcSoldState extends State<tryArcSold> {
