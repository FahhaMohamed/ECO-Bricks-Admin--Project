...
class cerbStoneAdd extends StatefulWidget {
  const cerbStoneAdd({super.key});

  @override
  State<cerbStoneAdd> createState() => _cerbStoneAddState();
}

class _cerbStoneAddState extends State<cerbStoneAdd> {

  CollectionReference? fileRef = FirebaseFirestore.instance.collection('Cerb Stone Pavers');
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
                                          ...
                                          children: [
                                            ...
                                            TextButton(
                                                onPressed: () async {
                                                  ...
                                                  await FirebaseFirestore.instance.collection('Cerb Stone Pavers').doc(color).set({
                                                    'color' : color,
                                                    'amount' : int.tryParse(amount),
                                                  });
                                                },
      ...
      child: Container(
        ...
        child: const Center(child: Text("Cerb Stone",style: TextStyle(fontSize: 19,color: Colors.black),)),
      ),
    );
  }
}
