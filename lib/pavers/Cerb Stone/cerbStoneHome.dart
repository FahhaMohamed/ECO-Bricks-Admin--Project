...
class cerbStoneHome extends StatefulWidget {

  final String url;

  const cerbStoneHome({required this.url,super.key});

  @override
  State<cerbStoneHome> createState() => _cerbStoneHomeState();
}

class _cerbStoneHomeState extends State<cerbStoneHome> {
  ...
  String name = 'Cerb Stone Pavers';

  CollectionReference? dataRef = FirebaseFirestore.instance.collection('pavers');

  fetchValue() async {

    var _value = await FirebaseFirestore.instance.collection('pavers').doc('Cerb Stone Pavers');
