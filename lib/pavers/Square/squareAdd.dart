...
class squareAdd extends StatefulWidget {
  const squareAdd({super.key});

  @override
  State<squareAdd> createState() => _squareAddState();
}

class _squareAddState extends State<squareAdd> {

  CollectionReference? fileRef = FirebaseFirestore.instance.collection('Square Pavers');
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
                                          ...
                                          children: [
                                            ...
                                            TextButton(
                                                onPressed: () async {
                                                  ...
                                                  await FirebaseFirestore.instance.collection('Square Pavers').doc(color).set({
                                                    'color' : color,
                                                    'amount' : int.tryParse(amount),
                                                  });
                                                },
      ...
      child: Container(
        ...
        child: const Center(child: Text("Square",style: TextStyle(fontSize: 19,color: Colors.black),)),
      ),
    );
  }
}
