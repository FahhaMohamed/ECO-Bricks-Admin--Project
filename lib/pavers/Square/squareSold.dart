...
class squareSold extends StatefulWidget {
  const squareSold({super.key});

  @override
  State<squareSold> createState() => _squareSoldState();
}

class _squareSoldState extends State<squareSold> {
