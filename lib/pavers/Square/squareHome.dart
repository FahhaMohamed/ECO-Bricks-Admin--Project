...
class squareHome extends StatefulWidget {
  ...
  const squareHome({required this.url,super.key});

  @override
  State<squareHome> createState() => _squareHomeState();
}
...
class _squareHomeState extends State<squareHome> {
  ...
  String name = 'Square Pavers';

  CollectionReference? dataRef = FirebaseFirestore.instance.collection('pavers');

  fetchValue() async {

    var _value = await FirebaseFirestore.instance.collection('pavers').doc('Square Pavers');
