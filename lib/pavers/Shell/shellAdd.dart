...
class shellAdd extends StatefulWidget {
  const shellAdd({super.key});

  @override
  State<shellAdd> createState() => _shellAddState();
}

class _shellAddState extends State<shellAdd> {

  CollectionReference? fileRef = FirebaseFirestore.instance.collection('Shell Pavers');
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
                                          ...
                                          children: [
                                            ...
                                            TextButton(
                                                onPressed: () async {
                                                  ...
                                                  await FirebaseFirestore.instance.collection('Shell Pavers').doc(color).set({
                                                    'color' : color,
                                                    'amount' : int.tryParse(amount),
                                                  });
                                                },
      ...
      child: Container(
        ...
        child: const Center(child: Text("Shell",style: TextStyle(fontSize: 19,color: Colors.black),)),
      ),
    );
  }
}
