...
class shellSold extends StatefulWidget {
  const shellSold({super.key});

  @override
  State<shellSold> createState() => _shellSoldState();
}

class _shellSoldState extends State<shellSold> {
