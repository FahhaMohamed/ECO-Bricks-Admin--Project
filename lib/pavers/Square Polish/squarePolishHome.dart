...
class squarePolishHome extends StatefulWidget {

  final String url;

  const squarePolishHome({required this.url,super.key});

  @override
  State<squarePolishHome> createState() => _squarePolishHomeState();
}

class _squarePolishHomeState extends State<squarePolishHome> {
  ...
  String name = 'Square Polish Pavers';

  CollectionReference? dataRef = FirebaseFirestore.instance.collection('pavers');

  fetchValue() async {

    var _value = await FirebaseFirestore.instance.collection('pavers').doc('Square Polish Pavers');
