...
class squarePolishAdd extends StatefulWidget {
  const squarePolishAdd({super.key});

  @override
  State<squarePolishAdd> createState() => _squarePolishAddState();
}

class _squarePolishAddState extends State<squarePolishAdd> {

  CollectionReference? fileRef = FirebaseFirestore.instance.collection('Square Polish Pavers');
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
                                          ...
                                          children: [
                                            ...
                                            TextButton(
                                                onPressed: () async {
                                                  ...
                                                  await FirebaseFirestore.instance.collection('Square Polish Pavers').doc(color).set({
                                                    'color' : color,
                                                    'amount' : int.tryParse(amount),
                                                  });
                                                },
      ...
      child: Container(
        ...
        child: const Center(child: Text("Square Polish",style: TextStyle(fontSize: 19,color: Colors.black),)),
      ),
    );
  }
}
