...
class squarePolishSold extends StatefulWidget {
  const squarePolishSold({super.key});

  @override
  State<squarePolishSold> createState() => _squarePolishSoldState();
}

class _squarePolishSoldState extends State<squarePolishSold> {
