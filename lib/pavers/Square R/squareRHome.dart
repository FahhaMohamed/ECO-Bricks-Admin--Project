...
class squareRHome extends StatefulWidget {

  final String url;

  const squareRHome({required this.url,super.key});

  @override
  State<squareRHome> createState() => _squareRHomeState();
}

class _squareRHomeState extends State<squareRHome> {
  ...
  String name = 'Square R Pavers';

  CollectionReference? dataRef = FirebaseFirestore.instance.collection('pavers');

  fetchValue() async {

    var _value = await FirebaseFirestore.instance.collection('pavers').doc('Square R Pavers');
