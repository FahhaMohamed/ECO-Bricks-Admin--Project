...
class squareRSold extends StatefulWidget {
  const squareRSold({super.key});

  @override
  State<squareRSold> createState() => _squareRSoldState();
}

class _squareRSoldState extends State<squareRSold> {
