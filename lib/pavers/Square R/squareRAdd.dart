...
class squareRAdd extends StatefulWidget {
  const squareRAdd({super.key});

  @override
  State<squareRAdd> createState() => _squareRAddState();
}

class _squareRAddState extends State<squareRAdd> {

  CollectionReference? fileRef = FirebaseFirestore.instance.collection('Square R Pavers');
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
                                          ...
                                          children: [
                                            ...
                                            TextButton(
                                                onPressed: () async {
                                                  ...
                                                  await FirebaseFirestore.instance.collection('Square R Pavers').doc(color).set({
                                                    'color' : color,
                                                    'amount' : int.tryParse(amount),
                                                  });
                                                },
      ...
      child: Container(
        ...
        child: const Center(child: Text("Square R",style: TextStyle(fontSize: 19,color: Colors.black),)),
      ),
    );
  }
}
