...
class bigTryArcAdd extends StatefulWidget {
  const bigTryArcAdd({super.key});

  @override
  State<bigTryArcAdd> createState() => _bigTryArcAddState();
}

class _bigTryArcAddState extends State<bigTryArcAdd> {

  CollectionReference? fileRef = FirebaseFirestore.instance.collection('Big Try Arc Pavers');
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
                                          ...
                                          children: [
                                            ...
                                            TextButton(
                                                onPressed: () async {
                                                  ...
                                                  await FirebaseFirestore.instance.collection('Big Try Arc Pavers').doc(color).set({
                                                    'color' : color,
                                                    'amount' : int.tryParse(amount),
                                                  });
                                                },
      ...
      child: Container(
        ...
        child: const Center(child: Text("Big Try Arc",style: TextStyle(fontSize: 19,color: Colors.black),)),
      ),
    );
  }
}
