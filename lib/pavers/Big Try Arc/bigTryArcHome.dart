...
class bigTryArcHome extends StatefulWidget {

  final String url;

  const bigTryArcHome({required this.url,super.key});

  @override
  State<bigTryArcHome> createState() => _bigTryArcHomeState();
}

class _bigTryArcHomeState extends State<bigTryArcHome> {
  ...
  String name = 'Big Try Arc Pavers';

  CollectionReference? dataRef = FirebaseFirestore.instance.collection('pavers');

  fetchValue() async {

    var _value = await FirebaseFirestore.instance.collection('pavers').doc('Big Try Arc Pavers');
