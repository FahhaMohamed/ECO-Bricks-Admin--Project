...
class bigTryArcSold extends StatefulWidget {
  const bigTryArcSold({super.key});

  @override
  State<bigTryArcSold> createState() => _bigTryArcSoldState();
}

class _bigTryArcSoldState extends State<bigTryArcSold> {
