...
class zigzagPolishSold extends StatefulWidget {
  const zigzagPolishSold({super.key});

  @override
  State<zigzagPolishSold> createState() => _zigzagPolishSoldState();
}

class _zigzagPolishSoldState extends State<zigzagPolishSold> {
