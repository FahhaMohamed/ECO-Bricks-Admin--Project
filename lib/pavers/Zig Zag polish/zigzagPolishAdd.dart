...
class zigzagPolishAdd extends StatefulWidget {
  const zigzagPolishAdd({super.key});

  @override
  State<zigzagPolishAdd> createState() => _zigzagPolishAddState();
}

class _zigzagPolishAddState extends State<zigzagPolishAdd> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
                                          ...
                                          children: [
                                            ...
                                            TextButton(
                                                onPressed: () async {
                                                  ...
                                                  await FirebaseFirestore.instance.collection('Zig Zag Polish Pavers').doc(color).set({
                                                    'color' : color,
                                                    'amount' : int.tryParse(amount),
                                                  });
                                                },
      ...
      child: Container(
        ...
        child: const Center(child: Text("Zig Zag Polish",style: TextStyle(fontSize: 19,color: Colors.black),)),
      ),
    );
  }
}
