...
class starAdd extends StatefulWidget {
  const starAdd({super.key});

  @override
  State<starAdd> createState() => _starAddState();
}

class _starAddState extends State<starAdd> {

  CollectionReference? fileRef = FirebaseFirestore.instance.collection('Star Pavers');
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
                                          ...
                                          children: [
                                            ...
                                            TextButton(
                                                onPressed: () async {
                                                  ...
                                                  await FirebaseFirestore.instance.collection('Star Pavers').doc(color).set({
                                                    'color' : color,
                                                    'amount' : int.tryParse(amount),
                                                  });
                                                },
      ...
      child: Container(
        ...
        child: const Center(child: Text("Star",style: TextStyle(fontSize: 19,color: Colors.black),)),
      ),
    );
  }
}
