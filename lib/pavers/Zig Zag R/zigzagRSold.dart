...
class zigzagRSold extends StatefulWidget {
  const zigzagRSold({super.key});

  @override
  State<zigzagRSold> createState() => _zigzagRSoldState();
}

class _zigzagRSoldState extends State<zigzagRSold> {
