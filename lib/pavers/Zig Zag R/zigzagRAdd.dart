...
class zigzagRAdd extends StatefulWidget {
  const zigzagRAdd({super.key});

  @override
  State<zigzagRAdd> createState() => _zigzagRAddState();
}

class _zigzagRAddState extends State<zigzagRAdd> {

  CollectionReference? fileRef = FirebaseFirestore.instance.collection('Zig Zag R Pavers');
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
                                          ...
                                          children: [
                                            ...
                                            TextButton(
                                                onPressed: () async {
                                                  ...
                                                  await FirebaseFirestore.instance.collection('Zig Zag R Pavers').doc(color).set({
                                                    'color' : color,
                                                    'amount' : int.tryParse(amount),
                                                  });
                                                },
      ...
      child: Container(
        ...
        child: const Center(child: Text("Zig Zag R",style: TextStyle(fontSize: 19,color: Colors.black),)),
      ),
    );
  }
}
