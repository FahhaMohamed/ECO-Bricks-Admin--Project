...
class grassPaverHome extends StatefulWidget {

  final String url;

  const grassPaverHome({required this.url,super.key});

  @override
  State<grassPaverHome> createState() => _grassPaverHomeState();
}

class _grassPaverHomeState extends State<grassPaverHome> {
  ...
  fetchValue() async {
    ...
    var _value = await FirebaseFirestore.instance.collection('pavers').doc('Grass Pavers');
