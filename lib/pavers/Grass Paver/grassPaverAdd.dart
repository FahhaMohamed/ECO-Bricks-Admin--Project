...
class grassPaverAdd extends StatefulWidget {
  const grassPaverAdd({super.key});

  @override
  State<grassPaverAdd> createState() => _grassPaverAddState();
}

class _grassPaverAddState extends State<grassPaverAdd> {

  CollectionReference? fileRef = FirebaseFirestore.instance.collection('Grass Pavers');
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
                                          ...
                                          children: [
                                            ...
                                            TextButton(
                                                onPressed: () async {
                                                  ...
                                                  await FirebaseFirestore.instance.collection('Grass Pavers').doc(color).set({
                                                    'color' : color,
                                                    'amount' : int.tryParse(amount),
                                                  });
                                                },
      ...
      child: Container(
        ...
        child: const Center(child: Text("Grass Paver",style: TextStyle(fontSize: 19,color: Colors.black),)),
      ),
    );
  }
}
