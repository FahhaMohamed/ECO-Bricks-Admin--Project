...
class oyalAdd extends StatefulWidget {
  const oyalAdd({super.key});

  @override
  State<oyalAdd> createState() => _oyalAddState();
}

class _oyalAddState extends State<oyalAdd> {

  CollectionReference? fileRef = FirebaseFirestore.instance.collection('Opel Pavers');
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
                                          ...
                                          children: [
                                            ...
                                            TextButton(
                                                onPressed: () async {
                                                  ...
                                                  await FirebaseFirestore.instance.collection('Opel Pavers').doc(color).set({
                                                    'color' : color,
                                                    'amount' : int.tryParse(amount),
                                                  });
                                                },
      ...
      child: Container(
        ...
        child: const Center(child: Text("Opel",style: TextStyle(fontSize: 19,color: Colors.black),)),
      ),
    );
  }
}
