...
class oyalHome extends StatefulWidget {

  final String url;

  const oyalHome({required this.url,super.key});

  @override
  State<oyalHome> createState() => _oyalHomeState();
}

class _oyalHomeState extends State<oyalHome> {
  ...
  String name = 'Opel Pavers';

  CollectionReference? dataRef = FirebaseFirestore.instance.collection('pavers');

  fetchValue() async {

    var _value = await FirebaseFirestore.instance.collection('pavers').doc('Opel Pavers');
