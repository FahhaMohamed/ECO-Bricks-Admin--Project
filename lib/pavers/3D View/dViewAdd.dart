...
class dViewAdd extends StatefulWidget {
  const dViewAdd({super.key});

  @override
  State<dViewAdd> createState() => _dViewAddState();
}

class _dViewAddState extends State<dViewAdd> {

  CollectionReference? fileRef = FirebaseFirestore.instance.collection('V Shape Pavers');
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
                                          ...
                                          children: [
                                            ...
                                            TextButton(
                                                onPressed: () async {
                                                  ...
                                                  await FirebaseFirestore.instance.collection('V Shape Pavers').doc(color).set({
                                                    'color' : color,
                                                    'amount' : int.tryParse(amount),
                                                  });
                                                },
      ...
      child: Container(
        ...
        child: const Center(child: Text("V Shape",style: TextStyle(fontSize: 19,color: Colors.black),)),
      ),
    );
  }
}
