...
class dViewHome extends StatefulWidget {

  final String url;

  const dViewHome({required this.url,super.key});

  @override
  State<dViewHome> createState() => _dViewHomeState();
}

class _dViewHomeState extends State<dViewHome> {
  ...
  fetchValue() async {
    ...
    var _value = await FirebaseFirestore.instance.collection('pavers').doc('V Shape Pavers');
                            ...
                            children: [
                              IconButton(
                                  onPressed: (){
                                    ...
                                    dataRef!.doc('V Shape Pavers').set({
                                      'value' : value,
                                    });
                                  },
