...
class dViewSold extends StatefulWidget {
  const dViewSold({super.key});

  @override
  State<dViewSold> createState() => _dViewSoldState();
}

class _dViewSoldState extends State<dViewSold> {
