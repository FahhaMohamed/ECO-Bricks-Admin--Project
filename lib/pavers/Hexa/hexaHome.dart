...
class hexaHome extends StatefulWidget {

  final String url;

  const hexaHome({required this.url,super.key});

  @override
  State<hexaHome> createState() => _hexaHomeState();
}

class _hexaHomeState extends State<hexaHome> {
  ...
  String name = 'Hexa Pavers';

  CollectionReference? dataRef = FirebaseFirestore.instance.collection('pavers');

  fetchValue() async {

    var _value = await FirebaseFirestore.instance.collection('pavers').doc('Hexa Pavers');
