...
class HexaAdd extends StatefulWidget {
  const HexaAdd({super.key});

  @override
  State<HexaAdd> createState() => _HexaAddState();
}

class _HexaAddState extends State<HexaAdd> {

  CollectionReference? fileRef = FirebaseFirestore.instance.collection('Hexa Pavers');
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
                                          ...
                                          children: [
                                            ...
                                            TextButton(
                                                onPressed: () async {
                                                  ...
                                                  await FirebaseFirestore.instance.collection('Hexa Pavers').doc(color).set({
                                                    'color' : color,
                                                    'amount' : int.tryParse(amount),
                                                  });
                                                },
      ...
      child: Container(
        ...
        child: const Center(child: Text("Hexa",style: TextStyle(fontSize: 19,color: Colors.black),)),
      ),
    );
  }
}
