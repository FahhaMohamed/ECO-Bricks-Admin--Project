...
class beeHiveSold extends StatefulWidget {
  const beeHiveSold({super.key});

  @override
  State<beeHiveSold> createState() => _beeHiveSoldState();
}

class _beeHiveSoldState extends State<beeHiveSold> {
