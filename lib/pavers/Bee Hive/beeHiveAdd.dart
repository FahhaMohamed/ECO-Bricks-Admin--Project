...
class beeHiveAdd extends StatefulWidget {
  const beeHiveAdd({super.key});

  @override
  State<beeHiveAdd> createState() => _beeHiveAddState();
}

class _beeHiveAddState extends State<beeHiveAdd> {

  CollectionReference? fileRef = FirebaseFirestore.instance.collection('Bee Hive Pavers');
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
                                          ...
                                          children: [
                                            ...
                                            TextButton(
                                                onPressed: () async {
                                                  ...
                                                  await FirebaseFirestore.instance.collection('Bee Hive Pavers').doc(color).set({
                                                    'color' : color,
                                                    'amount' : int.tryParse(amount),
                                                  });
                                                },
      ...
      child: Container(
        ...
        child: const Center(child: Text("Bee Hive",style: TextStyle(fontSize: 19,color: Colors.black),)),
      ),
    );
  }
}
