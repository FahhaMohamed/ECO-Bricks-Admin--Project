...
class beeHiveHome extends StatefulWidget {

  final String url;

  const beeHiveHome({required this.url,super.key});

  @override
  State<beeHiveHome> createState() => _beeHiveHomeState();
}

class _beeHiveHomeState extends State<beeHiveHome> {
  ...
  String name = 'Bee Hive Pavers';

  CollectionReference? dataRef = FirebaseFirestore.instance.collection('pavers');

  fetchValue() async {

    var _value = await FirebaseFirestore.instance.collection('pavers').doc('Bee Hive Pavers');
