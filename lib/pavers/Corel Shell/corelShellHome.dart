...
class corelShellHome extends StatefulWidget {

  final String url;

  const corelShellHome({required this.url,super.key});

  @override
  State<corelShellHome> createState() => _corelShellHomeState();
}

class _corelShellHomeState extends State<corelShellHome> {
  ...
  String name = 'Corel Shell Pavers';

  CollectionReference? dataRef = FirebaseFirestore.instance.collection('pavers');

  fetchValue() async {

    var _value = await FirebaseFirestore.instance.collection('pavers').doc('Corel Shell Pavers');
