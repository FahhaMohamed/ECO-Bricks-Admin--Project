...
class coralShellAdd extends StatefulWidget {
  const coralShellAdd({super.key});

  @override
  State<coralShellAdd> createState() => _coralShellAddState();
}

class _coralShellAddState extends State<coralShellAdd> {

  CollectionReference? fileRef = FirebaseFirestore.instance.collection('Corel Shell Pavers');
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
                                          ...
                                          children: [
                                            ...
                                            TextButton(
                                                onPressed: () async {
                                                  ...
                                                  await FirebaseFirestore.instance.collection('Corel Shell Pavers').doc(color).set({
                                                    'color' : color,
                                                    'amount' : int.tryParse(amount),
                                                  });
                                                },
      ...
      child: Container(
        ...
        child: const Center(child: Text("Coral Shell",style: TextStyle(fontSize: 19,color: Colors.black),)),
      ),
    );
  }
}
