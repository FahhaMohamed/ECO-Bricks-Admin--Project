...
class iShapeAdd extends StatefulWidget {
  const iShapeAdd({super.key});

  @override
  State<iShapeAdd> createState() => _iShapeAddState();
}

class _iShapeAddState extends State<iShapeAdd> {
                                          ...
                                          children: [
                                            ...
                                            TextButton(
                                                onPressed: () async {
                                                  ...
                                                  await FirebaseFirestore.instance.collection('I Shape Pavers').doc(color).set({
                                                    'color' : color,
                                                    'amount' : int.tryParse(amount),
                                                  });
                                                },
