...
class iShapeHome extends StatefulWidget {

  final String url;

  const iShapeHome({required this.url,super.key});

  @override
  State<iShapeHome> createState() => _iShapeHomeState();
}

class _iShapeHomeState extends State<iShapeHome> {
  ...
  fetchValue() async {
    ...
    var _value = await FirebaseFirestore.instance.collection('pavers').doc('I Shape Pavers');
                            ...
                            children: [
                              IconButton(
                                  onPressed: (){
                                    ...
                                    dataRef!.doc('I Shape Pavers').set({
                                      'value' : value,
                                    });
                                  },
